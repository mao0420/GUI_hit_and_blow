...
public class TitlePanel extends JPanel {
    ...
    public TitlePanel(ActionListener actionListener) {
        ...
        setFontInTitlePanel();
        buttonSettingsInTitlePanel();
        setAlignmentInTitlePanel();
        setActionInTitlePanel(actionListener);
    ...
    private void setActionInTitlePanel(ActionListener actionListener) {
    ...
    private void setAlignmentInTitlePanel() {
    ...
    private void buttonSettingsInTitlePanel() {
    ...
    private void setFontInTitlePanel() {
